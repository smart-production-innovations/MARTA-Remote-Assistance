...
///https://docs.unity3d.com/Packages/com.unity.xr.arfoundation@3.0/api/UnityEngine.XR.ARFoundation.ARPlaneMeshGenerators.html
...
public static class ARPlaneMeshGenerators
{
    ...
    public static bool GenerateMesh(Mesh mesh, Pose pose, Vector2[] convexPolygon, float areaTolerance = 1e-6f)
    {
        if (mesh == null)
